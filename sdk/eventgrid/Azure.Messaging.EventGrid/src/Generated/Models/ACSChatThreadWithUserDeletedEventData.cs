...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ACSChatThreadWithUserDeletedEventData : ACSChatThreadEventBaseProperties
    {
        ...
        internal ACSChatThreadWithUserDeletedEventData(string recipientId, string transactionId, string threadId, DateTimeOffset? createTime, UInt64? version, string deletedBy, DateTimeOffset? deleteTime) : base(recipientId, transactionId, threadId, createTime, version)
        {
            DeletedBy = deletedBy;
