...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ACSChatThreadCreatedWithUserEventData : ACSChatThreadEventBaseProperties
    {
        ...
        internal ACSChatThreadCreatedWithUserEventData(string recipientId, string transactionId, string threadId, DateTimeOffset? createTime, UInt64? version, string createdBy, IReadOnlyDictionary<string, object> properties, IReadOnlyList<ACSChatThreadMemberProperties> members) : base(recipientId, transactionId, threadId, createTime, version)
        {
            CreatedBy = createdBy;
