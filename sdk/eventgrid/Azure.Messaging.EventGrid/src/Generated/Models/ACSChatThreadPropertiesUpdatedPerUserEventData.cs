...
namespace Azure.Messaging.EventGrid.SystemEvents
{
    ...
    public partial class ACSChatThreadPropertiesUpdatedPerUserEventData : ACSChatThreadEventBaseProperties
    {
        ...
        internal ACSChatThreadPropertiesUpdatedPerUserEventData(string recipientId, string transactionId, string threadId, DateTimeOffset? createTime, UInt64? version, string editedBy, DateTimeOffset? editTime, IReadOnlyDictionary<string, object> properties) : base(recipientId, transactionId, threadId, createTime, version)
        {
            EditedBy = editedBy;
            EditTime = editTime;
