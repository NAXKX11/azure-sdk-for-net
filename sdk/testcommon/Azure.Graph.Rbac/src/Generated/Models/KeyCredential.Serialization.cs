    ...
    public partial class KeyCredential : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (StartDate != null)
            {
                ...
                writer.WriteStringValue(StartDate.Value, "S");
            }
            if (EndDate != null)
            {
                writer.WritePropertyName("endDate");
                writer.WriteStringValue(EndDate.Value, "S");
            }
            if (Value != null)
            {
        ...
        internal static KeyCredential DeserializeKeyCredential(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("startDate"))
                {
                    ...
                    startDate = property.Value.GetDateTimeOffset("S");
                    continue;
                }
                if (property.NameEquals("endDate"))
                {
                    ...
                    endDate = property.Value.GetDateTimeOffset("S");
                    continue;
                }
