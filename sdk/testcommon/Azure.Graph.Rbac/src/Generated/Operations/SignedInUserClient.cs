...
namespace Azure.Graph.Rbac
{
    public partial class SignedInUserClient
    {
        ...
        public SignedInUserClient(string tenantID, TokenCredential tokenCredential, RbacManagementClientOptions options = null)
        {
            options = options ?? new RbacManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new SignedInUserRestClient(_clientDiagnostics, _pipeline, tenantID, apiVersion: options.Version);
        }
