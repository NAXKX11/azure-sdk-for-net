...
namespace Azure.Graph.Rbac
{
    internal partial class UsersRestClient
    {
        ...
        /// <param name="securityEnabledOnly"> If true, only membership in security-enabled groups should be checked. Otherwise, membership in all groups should be checked. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<UserGetMemberGroupsResult>> GetMemberGroupsNextPageAsync(string nextLink, string objectId, bool securityEnabledOnly, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
        ...
        /// <param name="securityEnabledOnly"> If true, only membership in security-enabled groups should be checked. Otherwise, membership in all groups should be checked. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<UserGetMemberGroupsResult> GetMemberGroupsNextPage(string nextLink, string objectId, bool securityEnabledOnly, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
