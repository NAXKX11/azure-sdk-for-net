...
namespace Microsoft.Azure.ServiceBus
{
    ...
    public sealed class SessionHandlerOptions
    {
        ...
        /// <summary>Gets or sets the time to wait for receiving a message. This is the timeout the session is going to wait for the next avaliable message before closing. This value has an impact on the message throughput. </summary>
