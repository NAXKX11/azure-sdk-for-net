...
namespace Azure.Management.Resource
{
    internal partial class DeploymentScriptsRestClient
    {
        ...
        public DeploymentScriptsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
        ...
        public async ValueTask<Response> CreateAsync(string resourceGroupName, string scriptName, DeploymentScript deploymentScript, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DeploymentScriptsClient.Create");
            scope.Start();
            try
            {
        ...
        internal Core.HttpMessage CreateUpdateRequest(string resourceGroupName, string scriptName, IDictionary<string, string> tags)
        {
            ...
            request.Uri = uri;
            request.Headers.Add("Content-Type", "application/json");
            var model = new DeploymentScriptUpdateParameter()
            {
                Tags = tags
            };
            using var content = new Utf8JsonRequestContent();
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<DeploymentScript>> UpdateAsync(string resourceGroupName, string scriptName, IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
