...
namespace Azure.Management.Resource
{
    internal partial class TagsRestClient
    {
        ...
        internal Core.HttpMessage CreateCreateOrUpdateAtScopeRequest(string scope, Tags properties)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<TagsResource>> CreateOrUpdateAtScopeAsync(string scope, Tags properties, CancellationToken cancellationToken = default)
        {
            if (scope == null)
            {
        ...
        internal Core.HttpMessage CreateUpdateAtScopeRequest(string scope, TagsPatchResourceOperation? operation, Tags properties)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            request.Uri = uri;
            request.Headers.Add("Content-Type", "application/json");
            var model = new TagsPatchResource(operation, properties);
            using var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(model);
            request.Content = content;
            return message;
        ...
        /// <param name="properties"> The set of tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<TagsResource>> UpdateAtScopeAsync(string scope, TagsPatchResourceOperation? operation = null, Tags properties = null, CancellationToken cancellationToken = default)
        {
            if (scope == null)
            {
                throw new ArgumentNullException(nameof(scope));
